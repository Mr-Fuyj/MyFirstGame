...
//这个是坏结局，非常坏的那个
Scene* EndOfStay::createScene() {
	auto scene = Scene::create();

	auto layer = EndOfStay::create();
...
bool EndOfStay::init() {
	...
	Sprite *backGround = Sprite::create("BadEnd.jpg");
	...
	CocosDenshion::SimpleAudioEngine::getInstance()->playBackgroundMusic("BadEnd.mp3", true);
	Size s = Director::getInstance()->getVisibleSize(); //获取屏幕大小

	__Dictionary* string = __Dictionary::createWithContentsOfFile("EndOfStay.xml");
