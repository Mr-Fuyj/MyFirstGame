...
//留下来的结局，不太坏的那个
Scene* EndOfStayanother::createScene() {
	auto scene = Scene::create();

	auto layer = EndOfStayanother::create();
...
bool EndOfStayanother::init() {

	Sprite *backGround = Sprite::create("AnotherEnd.jpg");
	...
	__Dictionary* string = __Dictionary::createWithContentsOfFile("EndOfStayanother.xml");
